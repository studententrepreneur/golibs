...
func (x *LoginMessage) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *LoginMessage) GetClientSecret() string {
	if x != nil {
...
func (x *LoginMessage) GetLogin() string {
	if x != nil {
		return x.Login
	}
	return ""
...
func (x *LoginMessage) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
var file_login_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x01,
	0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1b,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x72,
	0x65, 0x70, 0x72, 0x65, 0x6e, 0x65, 0x75, 0x72, 0x2f, 0x67, 0x6f, 0x6c, 0x69, 0x62, 0x73, 0x2f,
