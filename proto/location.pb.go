...
func (x *LocationMessage) GetCountryCode() string {
	if x != nil {
...
func (x *LocationMessage) GetPostalCode() string {
	if x != nil {
		return x.PostalCode
	}
	return ""
...
func (x *LocationMessage) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
var file_location_proto_rawDesc = []byte{
	...
	0x22, 0x85, 0x01, 0x0a, 0x0f, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73,
	...
	0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x6f, 0x73, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x03,
	...
	0x52, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x72, 0x65, 0x70, 0x72, 0x65, 0x6e, 0x65, 0x75, 0x72, 0x2f, 0x67, 0x6f, 0x6c, 0x69, 0x62,
...
var file_location_proto_goTypes = []interface{}{
	(*LocationMessage)(nil), // 0: LocationMessage
}
