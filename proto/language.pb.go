...
type LanguageMessage struct {
	...
	Fluency  string `protobuf:"bytes,1,opt,name=fluency,proto3" json:"fluency,omitempty"`
...
func (x *LanguageMessage) GetFluency() string {
	if x != nil {
		return x.Fluency
	}
	return ""
...
func (x *LanguageMessage) GetLanguage() string {
	if x != nil {
		return x.Language
	}
	return ""
...
func (x *LanguageMessage) GetValue() uint32 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_language_proto_rawDesc = []byte{
	...
	0x22, 0x5d, 0x0a, 0x0f, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x66, 0x6c, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x66, 0x6c, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x1a, 0x0a,
	...
	0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42,
...
var file_language_proto_goTypes = []interface{}{
	(*LanguageMessage)(nil), // 0: LanguageMessage
}
