...
func (x *ReferenceMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReferenceMessage) ProtoMessage() {}

func (x *ReferenceMessage) ProtoReflect() protoreflect.Message {
	mi := &file_reference_proto_msgTypes[0]
...
// Deprecated: Use ReferenceMessage.ProtoReflect.Descriptor instead.
func (*ReferenceMessage) Descriptor() ([]byte, []int) {
	return file_reference_proto_rawDescGZIP(), []int{0}
}

func (x *ReferenceMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ReferenceMessage) GetReference() string {
	if x != nil {
		return x.Reference
	}
	return ""
...
var file_reference_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x44, 0x0a, 0x10, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x4d, 0x65,
	...
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_reference_proto_goTypes = []interface{}{
	(*ReferenceMessage)(nil), // 0: ReferenceMessage
}
