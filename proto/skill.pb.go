...
func (x *SkillMessage) GetKeywords() []string {
	if x != nil {
		return x.Keywords
	}
	return nil
...
func (x *SkillMessage) GetLevel() string {
	if x != nil {
		return x.Level
	}
	return ""
...
func (x *SkillMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *SkillMessage) GetValue() uint32 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_skill_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6a, 0x0a,
	0x0c, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1a, 0x0a,
	...
	0x28, 0x0d, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74,
...
var file_skill_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_skill_proto_goTypes = []interface{}{
	(*SkillMessage)(nil), // 0: SkillMessage
}
